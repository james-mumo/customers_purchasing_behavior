...
columns_to_remove <- c("Customer.Name", "Payment.Method", "Customer.Age", "Churn", "Returns")
...
print(paste("Correlation between Age and Total Purchase Amount:", cor_age_price))
