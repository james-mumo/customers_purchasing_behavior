...
# Create a line chart with a smooth curve
ggplot(total_purchase_by_age, aes(x = Age_Group, y = Total_Purchase_Amount_Made, group = 1)) +
  geom_point() +
  geom_smooth(method = "loess", se = FALSE) +  # Adding a smooth curve
...
ggplot(total_purchase_by_age, aes(x = Age_Group, y = Total_Purchase_Amount_Made)) +
  geom_point(color = "blue") +
  geom_line(aes(linewidth = 1), color = "blue") +  # Updated to use linewidth
  geom_bar(stat = "identity", fill = "green", alpha = 0.7) +  # Adding a bar chart
  labs(title = "Total Purchase Amount by Age Group",
       x = "Age Group",
       y = "Total Purchase Amount") +
  theme_minimal()
